//META{"authorId":"226677096091484160","name":"GuildData","displayName":"GuildData","website":"https://twitter.com/l0c4lh057/","source":"https://github.com/l0c4lh057/BetterDiscordStuff/blob/master/Plugins/GuildData/GuildData.plugin.js"}*//
...
class GuildData {
	...
	showUsers(gId, query=""){
		...
		btn2.on("click", ()=>{
			ZLibrary.DiscordModules.GuildMemberStore.getMembers(gId, '', 0);
		});
			...
			"2.0.4": [
				{
					...
					"type": "fixed",
					"items": [
						"Fixed load members not working at all."
					]
				}
			]
		};
